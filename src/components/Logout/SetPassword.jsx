...
export default function SetPassword() {
    ...
    return (
        <div style={{
            ...
            >
                <Title level={3} style={{ textAlign: 'center', fontFamily: 'Inter', fontSize: '32', fontWeight: '500' }}>Set a new password</Title>
                ...
                >
                    ...
                    <Form.Item style={{ marginTop: 44 }}>
                        <Link to="/login" ><LoginPageButton text="Reset Password"></LoginPageButton></Link>
                    </Form.Item>
                </Form>
            </Card>
        </div>
